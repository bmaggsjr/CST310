...
$sql = "INSERT INTO tbluser (p_email,p_password,p_firstname,p_lastname,p_address,p_phone,p_salary,p_ssn)
VALUES ('$p_email', '$p_password', '$p_fname', '$p_lname', '$p_address', '$p_phone', '$p_salary','$p_ssn')";
